    ...
    public void ControlClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.buttonB:
                ...
                Log.d("UWB", "ControlClick: Try to GET UWB");
                Toast.makeText(DataMonitor.this, "Start UWB", Toast.LENGTH_LONG).show();

//                final Intent intent_uwb = new Intent(this, UsbService.class);
//                startService(intent_uwb);
//				new AlertDialog.Builder(this)
//						.setTitle("提示")
//						.setIcon(android.R.drawable.ic_dialog_alert)
//						.setMessage("after start service")
//						.setPositiveButton("确定", new DialogInterface.OnClickListener() {
//							@Override
//							public void onClick(DialogInterface arg0, int arg1) {
//							}
...
//                    File targetFile = new File("/mnt/sdcard/test_uwb.txt");
//                    RandomAccessFile raf = new RandomAccessFile(targetFile, "rw");
//                    raf.seek(targetFile.length());
//                    String tmp_str = "tt";
//                    raf.write(tmp_str.getBytes());
//                    raf.close();
        ...
        switch (v.getId()) {
            ...
            case R.id.BtnRecord:
                if (this.recordStartorStop == false) {
                    // Start UWB
                    final Intent myUwbIntent=new Intent(this,UsbService.class);
                    startService(myUwbIntent);
